<?php 
function tpl_542eba30_layout__95v8arZBmlP8eggimcnSPA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<svg class="header-logo animate" x=0px y=0px viewBox="0 0 1280 720" enable-background="new 0 0 1280 720">
...
<textarea name=cform[details] placeholder="How can we help?" rows=8></textarea>
