<?php 
function tpl_542d843c_layout__95v8arZBmlP8eggimcnSPA(PHPTAL $tpl, PHPTAL_Context $ctx) {
$_thistpl = $tpl ;
...
<a href=#wwd>
                <?php 
/* tag "svg" from line 21 */ ;
if (false):  ;
?>
<svg class=scroll-down x=0px y=0px viewBox="0 0 40.007 40.007" enable-background="new 0 0 40.007 40.007;">
                </svg><?php endif; ?>

                <?php /* tag "svg" from line 23 */; ?>
<svg class=scroll-down x=0px y=0px viewBox="0 0 83 172.229" enable-background="new 0 0 83 172.229">
                    <?php 
/* tag "use" from line 24 */ ;
if (false):  ;
?>
<use xlink:href=/assets/images/map.svg#scroll-down></use><?php endif; ?>

                    <?php /* tag "use" from line 25 */; ?>
